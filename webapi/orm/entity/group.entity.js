...
__decorate([
    (0, typeorm_1.ManyToMany)(type => group_permission_1.Permission, { cascade: true })
    // @ManyToMany(type=>Permission) 
    ,
    (0, typeorm_1.JoinTable)({ name: "tblGroupPermission" }),
...
__decorate([
    (0, typeorm_1.ManyToOne)(type => department_1.Department),
    (0, typeorm_1.JoinColumn)({ name: "departmentID" }),
    __metadata("design:type", Array)
], Group.prototype, "department", void 0);
Group = __decorate([
    (0, typeorm_1.Entity)("tblGroup")
], Group);
exports.Group = Group;
